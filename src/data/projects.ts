...
export const projects: Project[] = [
  {
    ...
    githubUrl: "https://github.com/eufrnz/apiLogin",
    icon: "🔐",
    accentColor: "#60a5fa",
    featured: true,
  },
  {
    id: 2,
    title: "VanRoute - Sem Link Github (Projeto privado)",
    description:
  ...
  },
  {
    ...
    githubUrl: "https://github.com/devmarcolino/labor",
    icon: "🎫",
    accentColor: "#c4b5fd",
    featured: false,
  },
  {
    ...
    githubUrl: "https://github.com/eufrnz/beweare-ecommerce",
    icon: "🛍️",
    accentColor: "#bae6fd",
    featured: false,
  },
